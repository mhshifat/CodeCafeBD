...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var express__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! express */ \"express\");\n/* harmony import */ var express__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(express__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var nodemailer__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! nodemailer */ \"nodemailer\");\n/* harmony import */ var nodemailer__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(nodemailer__WEBPACK_IMPORTED_MODULE_1__);\n/* harmony import */ var _validators_contactValidator__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../validators/contactValidator */ \"./validators/contactValidator.js\");\n// Import Dependencies\r\n\r\n\r\n\r\n// Import Environment Variables\r\n__webpack_require__(/*! dotenv */ \"dotenv\").config();\r\n\r\n// Import Valuators\r\n\r\n\r\n// Setup Router\r\nconst router = express__WEBPACK_IMPORTED_MODULE_0___default.a.Router();\r\n\r\n// ============================\r\n// ========== Routes ==========\r\n// ============================\r\n\r\n// Route ==> (POST) /api/contact\r\nrouter.post(\"/contact\", async (req, res) => {\r\n  try {\r\n    const { name, email, subject, message } = req.body;\r\n    const { isValid, errors } = Object(_validators_contactValidator__WEBPACK_IMPORTED_MODULE_2__[\"default\"])(req.body);\r\n    if (!isValid) return res.status(400).json({ success: false, errors });\r\n    const transporter = nodemailer__WEBPACK_IMPORTED_MODULE_1___default.a.createTransport({\r\n      pool: true,\r\n      host: \"smtp.gmail.com\",\r\n      port: 465,\r\n      secure: true, // use TLS\r\n      auth: {\r\n        user: process.env.GOOGLE_USER,\r\n        pass: process.env.GOOGLE_PASS\r\n      },\r\n      tls: {\r\n        rejectUnauthorized: false\r\n      }\r\n    });\r\n    const mailOptions = {\r\n      from: name + `<${email}>`,\r\n      to: process.env.GOOGLE_USER,\r\n      subject: \"Message from codecafebd...\",\r\n      html: `\r\n        <h4>Name: ${name}</h4>\r\n        <h4>Email: ${email}</h4>\r\n        <h4>Subject: ${subject}</h4>\r\n        <br>\r\n        <br>\r\n        <hr>\r\n        <br>\r\n        <h4>Message: </h4>\r\n        <p>${message}</p>\r\n      `\r\n    };\r\n    const info = await transporter.sendMail(mailOptions);\r\n    if (info) {\r\n      return res.status(200).json({\r\n        success: true,\r\n        data: {\r\n          message: \"Your message has been sent\"\r\n        }\r\n      });\r\n    }\r\n  } catch (err) {\r\n    res.status(500).json({\r\n      success: false,\r\n      messages: {\r\n        message: \"Something went wrong, please try again later\"\r\n      }\r\n    });\r\n  }\r\n});\r\n\r\n// Export Router\r\n/* harmony default export */ __webpack_exports__[\"default\"] = (router);\r\n\n\n//# sourceURL=webpack:///./routes/Api/default.js?");
